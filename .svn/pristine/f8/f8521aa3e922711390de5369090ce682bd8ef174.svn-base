...
public class UpmLdapEvents {
	...
	public static void main(String a[]) throws Exception
	{
		...
		//ldapEvents.findUserByUserName("PF195851");
		ldapEvents.GetUserGroupsByUserName("PF074473");
		//ldapEvents.userAuthentication("PF111222","pf111222");
		//GetAllUsers();
		//ldapEvents.GetAllUserGroups();
		//ldapEvents.RemoveUserFromGroup("UPMadmin", "PF161852");
		//ldapEvents.AddUserToGroup("UPMadmin","PF161852");
		//ldapEvents.GetUserGroupsByUserName("PF150285");
